...
if __name__ == '__main__':
    ...
    # params = simulationParamsRobin.PreyParams(cmdargs.species, int(cmdargs.scenario))
    params = simulationParamsRobin.PreyParams("Robin", int(6))
